...
# Высота кнопок
$buttonHeight = 50
$verticalCenter = ($panel.Height - $buttonHeight) / 2
...
$stopButton.FlatAppearance.BorderSize = 0  # Убираем границу кнопки

# Обработчики событий для кнопки остановки
$stopButton.Add_MouseEnter({
    $this.ForeColor = [System.Drawing.Color]::Yellow  # Изменяем цвет текста при наведении
})

$stopButton.Add_MouseLeave({
    $this.ForeColor = [System.Drawing.Color]::White  # Возвращаем исходный цвет текста при уходе курсора
})
...
$startButton.FlatAppearance.BorderSize = 0  # Убираем границу кнопки

# Обработчики событий для кнопки запуска
